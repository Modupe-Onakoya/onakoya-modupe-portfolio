...
const Footer = () => {
    ...
    return (
        <motion.div
            ...
            className='py-4 flex flex-col justify-between  mx-auto sm:px-15 px-8 bg-white dark:bg-[#111418]'>
            <div className='flex flex-col sm:flex-row gap-3 py-15 border-t  justify-between items-center '>
            ...
            <div className='border-t border-[#1F242B] flex justify-between items-center py-10'>
                <p className='text-[14px] text-white  flex items-center gap-3 p-2 '>
                    ...
                    <span className='text-black dark:text-white'>2026  Onakoya Modupe. All rights reserved</span>
                </p>

                <p className='text-[12px] text-black dark:text-white'>Built with react js & tailswind css</p>
            </div>
